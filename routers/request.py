...
from fastapi import APIRouter, Depends, File, Form, HTTPException, UploadFile, status # Removed duplicate HTTPException, added status
...
async def create_request(
    ...
    customer_id: str = Form(...),  # Or UUID type if preferred
